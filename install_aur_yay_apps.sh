...
install_apps() {
  ...
  yay -S --noconfirm --needed --answerdiff None --answerclean None "${YAY_APPS[@]}"
  ...
  sudo pacman -S --noconfirm --needed lutris wine-staging winetricks giflib lib32-giflib lib32-gnutls lib32-v4l-utils lib32-libpulse lib32-alsa-plugins lib32-libxcomposite lib32-libxinerama lib32-ncurses lib32-libxml2 lib32-freetype2 lib32-libpng lib32-sdl2 lib32-mesa vulkan-intel lib32-vulkan-intel steam
  yay -S --noconfirm --needed --answerdiff None --answerclean None protonup-qt
